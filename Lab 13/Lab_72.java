        ...
        while (choice!=-1) {
            ...
            switch (choice) {
                case 1:
                    ...
                    num=sc.nextInt();
                    dll.insertAtFirstPosition(num);
                    break;

                case 2:
                    System.out.println("Enter Number :");
                    num=sc.nextInt();
                    dll.insertAtLastPosition(num);
                    break;

                case 3:
                    System.out.println("Enter Number :");
                    num=sc.nextInt();
                    dll.insertAtOrder(num);
                    break;
                ...
                case 4:
                    ...
                    System.out.println("Enter Number :");
                    num=sc.nextInt();
                    dll.insertAtSpecificPosition(index, num);
                    break;
                ...
                case 7:
                    System.out.println("Enter Index :");
                    index=sc.nextInt();
                    dll.deleteFromSpecificPosition(index);
                    break;

                case 8:
                    System.out.println("Enter Number :");
                    num=sc.nextInt();
                    dll.deleteGivenDataFromDoublyLinkedList(num);
                    break;
